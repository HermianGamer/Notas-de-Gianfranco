...
The `vanity_sort` function should return a list of influencers, ordered by their vanity from least to greatest. You can pass a function as a named parameter called `key` to [sorted](https://docs.python.org/3/library/functions.html#sorted) to control the metric the sorting algorithm will use for comparisons.