Exponents grow very large [**very quickly**](https://en.wikipedia.org/wiki/Wheat_and_chessboard_problem). Let's take a look at an example of them doing that, _in code_.
