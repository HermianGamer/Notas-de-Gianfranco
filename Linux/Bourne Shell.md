...
To get hand-wavy about it, I want to explain the difference between the 3 [[Shell]]s you're likely to encounter:
...
`bash` and `zsh` are a superset of `sh`. They can do anything `sh`can do, and more.