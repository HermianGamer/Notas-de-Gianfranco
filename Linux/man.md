The [man](https://www.ibm.com/docs/en/aix/7.3?topic=m-man-command) command is short for "manual". It's a program that displays the manual in the [[Terminal]] for other programs.

![RTFM](https://storage.googleapis.com/qvault-webapp-dynamic-assets/course_assets/tpIPc6I-958x500.jpg)
