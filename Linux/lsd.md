...
Note: You must install [the nerdfont](https://webinstall.dev/nerdfont) and update the font in your Terminal for `lsd` to show icons.

se descarga con [[webi]].
...
(you may also enjoy [`aliasman`](https://webinstall.dev/aliasman/))
...
Using [aliasman](https://webinstall.dev/aliasman):
