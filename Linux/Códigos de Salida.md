[Exit codes](https://en.wikipedia.org/wiki/Exit_status) (sometimes called "return codes" or "status codes") are how programs communicate back whether they ran successfully or not. en el [[CLI]], es como un [[help]] pero para saber que código de error se obtuvo.
