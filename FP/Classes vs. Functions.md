I run into new developers who, after learning about [[Class]]es, want to use them _everywhere_. They assume that because they learned about [[Function]]s first, functions are somehow inferior.
