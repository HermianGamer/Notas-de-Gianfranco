A [[Git]] [[repositorio]] is a (potentially very long) list of [[Commit]]s, where each commit represents the _full state of the repository_ at a given point in time.
