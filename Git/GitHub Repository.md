...
Just like we created a `webflyx-local` [[repositorio]] and used `webflyx` as a [[Remote]], [[Git]]Hub makes it easy to create "remote" repos that are hosted on their servers.