Last but not least, let's take a look at some of the built-in methods we can [[Overriding Built-In Methods]] in Python. While there isn't a default behavior for the arithmetic operators like we just saw, there _is_ a default behavior for **printing** a class instance:
